...
df.mg = fread(f.out,stringsAsFactors = F,data.table = F)
...
sum(df.mg$fdr_t21 < 0.2,na.rm = T)
sum(df.mg$fdr_t21 < 0.2 & (df.mg$fdr_H > 0.2 | is.na(df.mg$fdr_H)),na.rm = T)
sum(df.mg$fdr_t21 < 0.2 & (df.mg$fdr_H > 0.2 | is.na(df.mg$fdr_H)) & df.mg$fdr_int < 0.2,na.rm = T)
sum(df.mg$fdr_t21 < 0.2 & (df.mg$fdr_H > 0.2 | is.na(df.mg$fdr_H)) & df.mg$fdr_int < 0.2,na.rm = T)
sum(df.mg$fdr_t21 < 0.2 & (df.mg$fdr_H > 0.2 | is.na(df.mg$fdr_H)) & df.mg$fdr_int < 0.2,na.rm = T)
...
dim(subset(df.mg.sub,fdr_t21 < 0.2 & (fdr_H > 0.2 | is.na(fdr_H)) & fdr_int < 0.2))
# df.mg.sub.t21 = subset(df.mg.sub,fdr_t21 < 0.2 & (fdr_H > 0.2 | is.na(fdr_H)) & fdr < 0.2)
df.mg.sub.t21 = subset(df.mg.sub,fdr_t21 < 0.2 & (fdr_H > 0.2 | is.na(fdr_H)) & fdr_int > 0.2)
head(df.mg.sub.t21)
